...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__style__ = __webpack_require__(19);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__text__ = __webpack_require__(68);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__src_selectorAll__ = __webpack_require__(20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__src_selection_style__ = __webpack_require__(19);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__src_touch__ = __webpack_require__(69);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__src_touches__ = __webpack_require__(70);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__src_window__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__src_selection_on__ = __webpack_require__(8);
...
var _contextMenu = __webpack_require__(21);
...
var _d3Drag = __webpack_require__(27);
  ...
  _createClass(MeasureTool, [{
    ...
    value: function _init() {
      ...
      if (this._options.tooltip) {
        this._tooltip = new _tooltip2.default(this._map.getDiv());
      }
    ...
    value: function _updateSegmentText() {
      ...
      var text = this._segmentText.selectAll("text").data(this._geometry ? this._geometry.lines : []).attr('class', 'segment-measure-text').attr('text-anchor', 'middle').attr('dominant-baseline', 'text-after-edge').attr('transform', function (d) {
        var p1 = _this5._projectionUtility.latLngToSvgPoint(d[0]);
        var p2 = _this5._projectionUtility.latLngToSvgPoint(d[1]);
        return _this5._doTextTransform(p1, p2);
      }).text(function (d, i) {
        return _this5._helper.formatLength(_this5._helper.computeLengthBetween(d[0], d[1]));
      });

      text.enter().append('text').attr('class', 'segment-measure-text').attr('text-anchor', 'middle').attr('dominant-baseline', 'text-after-edge').attr('transform', function (d) {
        var p1 = _this5._projectionUtility.latLngToSvgPoint(d[0]);
        var p2 = _this5._projectionUtility.latLngToSvgPoint(d[1]);
        return _this5._doTextTransform(p1, p2);
      }).text(function (d, i) {
    ...
    value: function _updateSegmentTextPosition(index) {
      ...
      if (index < this._geometry.lines.length) {
        this._segmentText.select('text:nth-child(' + (index + 1) + ')').attr('transform', function (d) {
          ...
          return _this8._doTextTransform(p1, p2);
        }).text(function (d) {
    ...
    key: '_doTextTransform',
    value: function _doTextTransform(p1, p2) {
      var mid = _helper2.default.findMidPoint([p1, p2]);
      var angle = void 0;
      if (p1[0] === p2[0]) {
    ...
    value: function _updateArea(i, pointToCompare) {
      ...
      this._area = area;
      if (area > 0) {
        this._nodeText.select(':last-child').text(this._options.i18n.totalDistance + ': ' + this.lengthText + '; ' + this._options.i18n.totalArea + ': ' + this.areaText + '.');
      }
    }
  }, {
    ...
    value: function _dispatchMeasureEvent() {
      ...
      if (typeof this._events.get(_events.EVENT_CHANGE) === "function") {
        this._events.get(_events.EVENT_CHANGE)({
          result: {
            length: this.length,
            lengthText: this.lengthText,
            area: this.area,
...
// module
exports.push([module.i, ".measure-tool-tooltip {\n  font-family: Roboto, Arial, sans-serif;\n  margin: 6px 15px;\n  background-color: #fff;\n  border-radius: 2px;\n  box-shadow: 0 1px 4px rgba(0, 0, 0, 0.3);\n  padding: 10px;\n  overflow: hidden;\n  pointer-events: none;\n  font-size: 0.7rem; }\n", "", {"version":3,"sources":["/Volumes/MacData/-=Projects=-/Web-Projects/StormProjects/agrio.work/assets/js/vendor/MeasureTool-GoogleMaps-V3/src/tooltip.scss"],"names":[],"mappings":"AACA;EACE,uCAFqC;EAGrC,iBAAgB;EAChB,uBAAsB;EACtB,mBAAkB;EAClB,yCAAqC;EACrC,cAAa;EACb,iBAAgB;EAChB,qBAAoB;EACpB,kBAAiB,EAClB","file":"tooltip.scss","sourcesContent":["$font-family: Roboto, Arial, sans-serif;\n.measure-tool-tooltip {\n  font-family: $font-family;\n  margin: 6px 15px;\n  background-color: #fff;\n  border-radius: 2px;\n  box-shadow: 0 1px 4px rgba(0,0,0,0.3);\n  padding: 10px;\n  overflow: hidden;\n  pointer-events: none;\n  font-size: 0.7rem;\n}"],"sourceRoot":""}]);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__index__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__selectorAll__ = __webpack_require__(20);
